...
let worldPoint = this.cameras.main.getWorldPoint(this.cameras.main.width , this.cameras.main.height );
...
worldPoint.y + (this.cameras.main.height ) / zoomFactor + 10
 ...
 fixedText1.setPosition(
        worldPoint.x - (this.cameras.main.width ) / zoomFactor + 100, 
worldPoint.y - (this.cameras.main.height ) / zoomFactor + 100
    );
