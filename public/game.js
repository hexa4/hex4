...
//CREATE   //CREATE //CREATE //CREATE //CREATE //CREATE //CREATE //CREATE //CREATE //CREATE //CREATE //CREATE //CREATE 
        ...
        function create() {
		 ...
		 //CREACION DEL MAPA HEXAGONAL
            ...
            //PLAYER 2 LOCAL DESACTIVADO
            player2 = this.add.circle(randomVertex.x, randomVertex.y, 20, 0xffffff);
        	player2.setScale(0);           
            player2.setInteractive();
            player2.vertices = [];
            
            //INVOCAR RED CIRCLES AL START 
            updateRedVertices.call(this, randomVertex.x, randomVertex.y);
            
            this.input.on('pointerdown', onPointerDown, this);
            
            //LLAMA GREENCIRCLES DESDE SERVER PARA ACTIVARLO
...
//CHECKBOX CAM MOVE
        ...
        let checkboxSize = 20;
        let checkboxX = 10;
        let checkboxY = this.scale.height - 40;
...
staticText.setScrollFactor(0);
    ...
    function resizeTexts() {
        ...
        fixedText1.setPosition(10, 10);
        fixedText2.setPosition(10, 30);
        fixedText3.setPosition(10, 50);
        fixedText4.setPosition(10, 70);
        fixedText5.setPosition(10, 90);

        fixedText6.setPosition(window.innerWidth - 10, 10);
                fixedText7.setPosition(window.innerWidth - 10, 30);


 boxX = 10;
        boxY = window.innerHeight - 70;
        staticText.setPosition(boxX + boxSize + 10, boxY + textYOffset);
        drawBoxCheck(isBoxChecked); // Redibujar el checkbox en la nueva posición
  
  
  checkboxX = 10;
        checkboxY = window.innerHeight - 40;
        fixedText.setPosition(checkboxX + checkboxSize + 10, checkboxY + textOffsetY);
        drawCheck(isChecked); // Redibujar el checkbox de Centered Cam en la nueva posición



    }

    // Asegurarse de que la posición sea correcta al inicio
    resizeTexts();
